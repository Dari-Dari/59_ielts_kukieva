            ...
            <div class="col-md-6 block-4__text-block">
              <div class="block-4__card-body">
                ...
                <ul class="list-group__block4 list-group-flush">
                  <li class="list-group-item d-flex align-items-center border-0">
                    <img src="assets/icons/icon _arrow circle right_.svg" class="bi bi-arrow-right-circle"
                      ...
                      <p class="list-group-item__elements" id="first_item">Лингвист-переводчик, Уральский Федеральный Университет (УрФУ), Физико-технический факультет,
                    Кафедра
                  ...
                  <li class="list-group-item d-flex align-items-center border-0">
                    <img src="assets/icons/icon _arrow circle right_.svg" class="bi bi-arrow-right-circle"
                      alt="icon arrow circle right">
                      <p class="list-group-item__elements" id="second_item">Международные сертификаты по методике преподавания  - Cambridge CELTA, TKT</p>
                  </li>
                  <li class="list-group-item d-flex align-items-center border-0">
                    <img src="assets/icons/icon _arrow circle right_.svg" class="bi bi-arrow-right-circle"
                      alt="icon arrow circle right">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item__second d-flex align-items-center border-0">
                  <img src="assets/icons/dot.svg" alt="dot" class="dot__icon">
                  <p class="list-group-item__elements" id="seventh_item">Тьютор на курсе Академического письма (формат IELTS)</p>
                  </li>
                  <li class="list-group-item__second d-flex align-items-center border-0">
                  <img src="assets/icons/dot.svg" alt="dot" class="dot__icon">
                  <p class="list-group-item__elements" id="eighth_item">Создала свой курс по написанию писем - IELTS General (Writing Task 1)</p>
                  </li>
                  <li class="list-group-item__second d-flex align-items-center border-0">
                  <img src="assets/icons/dot.svg" alt="dot" class="dot__icon">
